...
class APITestCase(unittest.TestCase):
    ...
    def test_login(self):
        ...
        """
        data = {"username": "test", "nickname": "21321"}
        ...
        self.assertNotEqual(json_data['userId'], None)
    ...
    def test_register(self):
        ...
        """
        data = {"username": 'HeMu123', "password": 'AB123cd*_a', "nickname": "321", "url": "http://baidu.com", "magic_number": 7, "mobile": "+86.123456789012"}
        response = current_app.test_client().post(
            url_for('user.register_user'),
            json=data
        )
        ...
        data = {"username": "HeMu123", "password": "AB123cd*_a"}
        response = current_app.test_client().patch(
            url_for('user.login'),
            json=data
        )
        ...
        self.assertNotEqual(json_data['jwt'], None)
        self.assertNotEqual(json_data['userId'], None)
        self.assertEqual(json_data['username'], "HeMu123")
        self.assertEqual(json_data['nickname'], "321")
        self.assertEqual(response.status_code, 200)
